...
(async () => {
  ...
  await fs.writeFile("history-of-pregnancy-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("history-of-pregnancy-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
